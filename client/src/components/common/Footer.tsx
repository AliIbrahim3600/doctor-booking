    ...
    <footer className="w-full rounded-t-[1.5rem] mt-20">
      <div className="w-full py-16 px-8 flex flex-col items-center gap-8 max-w-7xl mx-auto">
        <div className="flex flex-col items-center gap-4">
          <div className="font-headline font-black text-blue-900 dark:text-blue-500 text-2xl">Doctor Booking</div>
        ...
        <div className="text-slate-500 font-body text-sm leading-relaxed">© {year} Doctor Booking. All rights reserved.</div>
      </div>
    </footer>
  );
}
